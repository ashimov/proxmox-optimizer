...
#
# DEPRECATED: Proxmox 7 is end-of-life. Use debian12-2-proxmox8.sh or debian13-2-proxmox9.sh instead.
#
# License: BSD (Berkeley Software Distribution)
#
################################################################################
#
# Assumptions: Debian 11 installed with a valid FQDN hostname set
#
...
#
# Usage:
# curl -O https://raw.githubusercontent.com/ashimov/proxmox-optimizer/master/debian-2-proxmox/debian11-2-proxmox7.sh && chmod +x debian11-2-proxmox7.sh
